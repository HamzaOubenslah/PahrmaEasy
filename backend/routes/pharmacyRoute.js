...
PharmacyRouter.patch(
  "/change-password",
  VerifyToken,
  pharmacyController.changePassword
);
...
PharmacyRouter.delete(
  "/medicines/:medicineId",
  VerifyToken,
  pharmacyController.removeMedicine
);
// Reviews routes
PharmacyRouter.get(
  "/reviews",
  VerifyToken,
  pharmacyController.getPharmacyReviews
);
PharmacyRouter.delete(
  "/reviews/:reviewId",
  VerifyToken,
  pharmacyController.deletePharmacyReview
);
...
PharmacyRouter.get(
  "/categories",
  VerifyToken,
  pharmacyController.getCategories
);
PharmacyRouter.post(
  "/categories",
  VerifyToken,
...
PharmacyRouter.get("/", pharmacyController.fetchPharmacies);
PharmacyRouter.get('/:id',pharmacyController.getPharmacyDetails)
